...
class FishingBot:
    ...
    def press_action_button(self, timeout=3.0, poll=1):
        """Пробует нажать кнопку действия в зависимости от режима (забрать/отпустить)."""
        ...
        print(f"Кнопка {button_name} не найдена за {timeout} сек.")
        return False
